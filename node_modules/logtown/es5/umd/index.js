(function (global, factory) {
  ...
  function buildMessageOptions(id) {
    ...
    var options = deepmerge_1.all([{}, get(configRegistry, "namespaces.".concat(id), {}), {
  ...
  function getLogger(id) {
    ...
    set$1(configRegistry, "namespaces.".concat(id), deepmerge_1(get(configRegistry, "namespaces.".concat(id), {}), config, deepMergeOptions));
  ...
  function configure() {
    ...
    configRegistry = override ? config : deepmerge_1(configRegistry, config, deepMergeOptions);
  }
  /**
